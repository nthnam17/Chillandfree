                        ...
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                            ...
                            <form class="form-body form-disabled">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control description_category" group="data" name="description" type="text" autocomplete="off" spellcheck="false" placeholder="Mô tả ngắn" disabled="true"></textarea>
                                </div>
                                <div class="form-group">
...
<script>
    $(document).ready(function () {
        const config = {
            urlGetModelFromDb: "/admin/category_blogs/getCategory",
            urlUpdateModelToDb: "/admin/category_blogs/edit",
            urlDeleteModelToDb: "/admin/category_blogs/delete",
        }
        ...
        function loadDataByidPopUp($id) {
            ...
            $(".description_category").val(lstData.description);
