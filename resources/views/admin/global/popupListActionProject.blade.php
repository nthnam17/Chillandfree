...
<div id="modal-project-tab" class="modal fade" role="dialog">
                        ...
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                            ...
                            <form class="form-body form-disabled">
                                        ...
                                        <div class="fileupload-preview fileupload-exists">
                                            <div class="preview-image-wrapper-white">
                                                <div class="field-news-image">
                                                    <label class="btn btnChoose" onclick="setImage('image_edit_project');">
                                                        <i class="fas fa-image" aria-hidden="true"></i>
                                                    </label>
                                                </div>
                                                <img src="/admin/img/placeholder.png" width="150" alt="" id="image_edit_project"
                                                        name="image_edit_project"
                                                        group="data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" group="data" name="name" type="text" autocomplete="off" spellcheck="false" placeholder="Tên dự án" disabled="true">
                                </div>
                                <div class="form-group">
                                    <label class="control-label required">Khách hàng</label>
                                    <input class="form-control" group="data" name="customer_name" type="text" autocomplete="off" spellcheck="false" placeholder="Khách hàng" disabled="true">
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Mô tả ngắn</label>
                                    <textarea class="form-control description_project" group="data" name="description" type="text" autocomplete="off" spellcheck="false" placeholder="Mô tả ngắn" disabled="true"></textarea>
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Nội dung </label>
                                    <textarea class="form-control content_project_edit" group="data" name="content_project_edit" type="text" autocomplete="off" spellcheck="false" placeholder="Nội dung"></textarea>
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Thời gian diễn ra </label>
                                    <input  class="form-control dateRangePicker" type="text" group="data" name="dates" />
                                </div>
...
<script>
    $(document).ready(function () {
        ...
        const config = {
            urlGetModelFromDb: "/admin/project/getData",
            urlUpdateModelToDb: "/admin/project/edit",
            urlDeleteModelToDb: "/admin/project/delete",
        }

        let idUser = '';
        $('#idTable tbody').on('click', '.list-project-modal', function () {
            self = this;
            idUser = $(self).data("id");
        ...
        function loadDataByidPopUp($id) {
            ...
            $("input[name='customer_name']").val(lstData.customer_name);
            // $("input[name='dates']").val(lstData.dates_edit);
            $(".select-status").val(lstData.status);
            $(".description_project").val(lstData.description);
            $(".dateRangePicker").val(lstData.dates);
            $("#image_edit_project").attr('src', lstData.image);
            CKEDITOR.instances['content_project_edit'].setData(lstData.content);
        ...
        $(document).on("click", "#btnUpdateEvent", function () {
            let data = {
                ...
                'dates': $(".dateRangePicker").val(),
                'image':$("#image_edit_project").attr('src'),
