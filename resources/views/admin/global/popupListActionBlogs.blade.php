<div id="modal-blogs-tab" class="modal fade" role="dialog">
                        ...
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                            ...
                            <form class="form-body form-disabled">
                                        ...
                                        <div class="fileupload-preview fileupload-exists">
                                            <div class="preview-image-wrapper-white">
                                                <div class="field-news-image">
                                                    <label class="btn btnChoose" onclick="setImage('image_blogs');">
                                                        <i class="fas fa-image" aria-hidden="true"></i>
                                                    </label>
                                                </div>
                                                <img src="/admin/img/placeholder.png" width="150" alt="" id="image_blogs"
                                                        name="image_blogs"
                                                        group="data">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control description_blog" group="data" name="description" type="text" autocomplete="off" spellcheck="false" placeholder="Mô tả ngắn" disabled="true"></textarea>
                                </div>
                                <div class="form-group">
                                    <label class="control-label">Nội dung</label>
                                    <textarea class="form-control content_edit" group="data" name="content_edit" type="text" autocomplete="off" spellcheck="false" placeholder=""></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="control-label required">Danh mục<span>*</span></label>
                                    <select class="form-control select-category " group="data" name="category_blog_id" disabled="true">
                                        <option value="">Lựa chọn</option>
                                        <?php use App\Models\CategoryBlogs; $data = CategoryBlogs::getAllCategory()?>
...
<script>
    $(document).ready(function () {
        ...
        const config = {
            urlGetModelFromDb: "/admin/blogs/getBlogs",
            urlUpdateModelToDb: "/admin/blogs/edit",
            urlDeleteModelToDb: "/admin/blogs/delete",
        }

        let idUser = '';
        $('#idTable tbody').on('click', '.list-blogs-modal', function () {
            self = this;
            idUser = $(self).data("id");
        ...
        $(document).on("click", "#btnUpdateEvent", function () {
            let data = {
                ...
                'category_blog_id': $(".select-category").val(),
                'image':$("#image_blogs").attr('src'),
                'description':$('.description_blog').val(),
