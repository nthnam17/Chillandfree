    ...
    <div class="modal-dialog " style="width: 500px; margin-top:15%">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer modal-footer-delete">
                <button type="button" class="btn btn-dagerdel my-btn-default " id="eventDelete">
...
<script>
    ...
    let id = '';
    let url = '';
    $('.modal').on('click', '.idDelete', function () {
        // console.log($(this).attr('data-id'),'ccc');
         id = $(this).attr('data-id');
         url = $(this).attr('data-url')
    })

    console.log('35434534534534')
    $('#idTable tbody').on('click', '.deleteDialog', function () {
