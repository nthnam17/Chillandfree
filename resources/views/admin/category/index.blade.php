...
@section('pageTitle', 'Quản lý danh mục')
@section('content')
    <style>
        .main-search {
                ...
                <div class="card-body main-content-group">
                    ...
                    <div class="d-flex justify-content-end mb-3">
                        <div class="card-header-actions">
                            @if(Role_has_permissions::hasPermissionByName('Thêm mới danh mục'))
                            ...
                            <table class="table table-striped border table-hover datatable dataTable no-footer" role="grid"
                                ...
                                <tr role="row" class="align-middle odd" id="templateRow" style="display: none">
                                    ...
                                    <td class="text-center">
                                        @if(Role_has_permissions::hasPermissionByName('Cập nhập danh mục'))
                                        ...
                                        @endif
                                        @if(Role_has_permissions::hasPermissionByName('Xóa danh mục'))
                ...
                <div class="modal-body">
                    <form class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" group="data" name="description" type="text"
    ...
    <script>
        ...
        $(document).ready(function () {
            // Model: Permission
            const config = {
                urlList: "/admin/category/list",
                urlGetModelFromDb: "/admin/category/get",
            ...
            function reLoadOption() {
                ...
                if (arrResult.code == 200) {
                    ...
                    if(Array.isArray(arrResult.data)){
     ...
     <script>
        $(document).ready(function() {
            $("input[name='name']").on('input', function() {
                ...
                var inputSlug = convertViToEn(inputValue) 
                $("input[name='slug']").val('/'+inputSlug)
            });
        });
    </script>
@endsection
